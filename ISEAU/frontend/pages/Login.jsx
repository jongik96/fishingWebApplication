...
const Login = () => {
  return (
    <div>
      ...
      <div className="relative w-1/3 my-6 mx-auto max-w-3xl bg-white outline-none focus:outline-none">
        {/*content*/}
        <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full">
          ...
          <div className="relative p-6 flex-auto">
            <p className="my-4 text-black-400 text-lg leading-relaxed">E-mail</p>
            <input
              type="text"
              placeholder="Email"
              className="text-lg w-full rounded-lg border-2 border-gray-400"
            />
            <p className="my-4 text-black-900 text-lg leading-relaxed">Password</p>
            <input
              type="password"
          ...
          <div className="flex items-center justify-end border-t border-solid border-blueGray-200 rounded-b">
            ...
            <button
              className="text-yellow-500 background-transparent font-bold uppercase px-6 py-2 text-sm  focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
              type="button"
            >
              Signup
            </button>
